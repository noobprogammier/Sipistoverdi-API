...
#root = CreateDocument()
#root.addExplain(element="info", description="This is only for Abba!")
#root.addRoot(function="open")
#root.add_Element(element="Inc", value="Che e negur!")
#root.add_SubDesc(focus="Inc", description="Inc e super golqm negur!")
#root.add_Element(element="Pedro", value="Pedro e bql!")
#root.add_SubDesc(focus="Pedro", description="Pedro e super bql!")
#root.add_Logic(variables=["Pedro", "Inc"], function=">")
